...
public class StateFactory extends HibernateFactory {
    ...
    public static Optional<OrgStateRevision> latestStateRevision(Org org) {
        String sql =
                "SELECT *, null as created, null as creator_id FROM " +
                        "suseOrgStateRevision WHERE org_id = :org AND state_revision_id = " +
                        "(SELECT MAX(id) FROM suseStateRevision)";
    ...
    public static Optional<ServerGroupStateRevision> latestStateRevision(
        ...
        String sql =
                "SELECT *, null as created, null as creator_id FROM " +
                        "suseServerGroupStateRevision WHERE group_id = :group AND state_revision_id = " +
                        "(SELECT MAX(id) FROM suseStateRevision)";
    ...
    public static Optional<ServerStateRevision> latestStateRevision(MinionServer server) {
        String sql =
                "SELECT *, null as created, null as creator_id FROM " +
                        "suseServerStateRevision WHERE server_id = :server AND state_revision_id = " +
                        "(SELECT MAX(id) FROM suseStateRevision)";
